...
ggplot(goals_by_league, aes(x = Competition, y = Goals, fill = Player)) +
...
goat_data$Result <- as.character(goat_data$Result)

# Create a new dataframe to calculate the wins
goat_data_wins <- goat_data %>%
